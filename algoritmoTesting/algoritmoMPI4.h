...
void executarAlgoritmoMPI4(unsigned char *img, int total_size);

//Main
int mpi4(char* imageName, int argc, char *argv[]){
	// Iniciando MPI
	int rank, num_procs;
	MPI_Init(&argc, &argv);
	...
	executarAlgoritmoMPI4(partial_img, size_per_proc);
